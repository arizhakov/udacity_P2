...
def predictions(dataframe):
    ...
    ##########################################################################################
    #features = dataframe[['rain', 'precipi', 'Hour', 'meantempi']] # = 0.431332208902
    features = dataframe[['rain', 'precipi', 'Hour', 'meantempi', 'fog','meanwindspdi','mintempi','maxtempi']] #0.432484956326
